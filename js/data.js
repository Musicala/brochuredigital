...
(function () {
  ...
  window.MUSICALA_CATALOG = {
    ...
    catalogo: [
      // ---- MÚSICA ----
      { id: 'piano', area: 'Música', title: 'Piano', img: './assets/catalogo/piano.webp', modalidades: ['sede', 'hogar', 'virtual'],
        bullets: ['Para niños, jóvenes y adultos.', 'Puedes empezar desde cero.', 'Técnica, canciones y lectura a tu ritmo.'] },
      { id: 'guitarra', area: 'Música', title: 'Guitarra', img: './assets/catalogo/guitarra.webp', modalidades: ['sede', 'hogar', 'virtual'],
        bullets: ['Acordes y ritmo desde el primer día.', 'Canciones reales que te gustan.', 'Avance rápido y práctico.'] },
      { id: 'canto', area: 'Música', title: 'Canto', img: './assets/catalogo/canto.webp', modalidades: ['sede', 'virtual'],
        bullets: ['Respiración, afinación y técnica vocal.', 'Repertorio según tu estilo.', 'Ideal para ganar confianza al cantar.'] },
      { id: 'violin', area: 'Música', title: 'Violín', img: './assets/catalogo/violin.webp', modalidades: ['sede', 'hogar', 'virtual'],
        bullets: ['Postura y técnica desde cero.', 'Lectura musical guiada.', 'Para niños, jóvenes y adultos.'] },
      { id: 'ukelele', area: 'Música', title: 'Ukelele', img: './assets/catalogo/ukelele.webp', modalidades: ['sede', 'virtual'],
        bullets: ['Fácil y divertido para empezar.', 'Toca canciones muy pronto.', 'Ideal como primer instrumento.'] },
      { id: 'bajo', area: 'Música', title: 'Bajo', img: './assets/catalogo/bajo.webp', modalidades: ['sede', 'virtual'],
        bullets: ['Groove y acompañamiento.', 'Técnica para tocar en banda.', 'Desde cero o nivel intermedio.'] },
      { id: 'teclado', area: 'Música', title: 'Teclado', img: './assets/catalogo/teclado.webp', modalidades: ['sede', 'hogar', 'virtual'],
        bullets: ['Armonía y acompañamiento.', 'Canciones y sonidos.', 'Ideal para iniciar en teclas.'] },
      { id: 'musibabies', area: 'Música', title: 'Musibabies', img: './assets/catalogo/musibabies.webp', modalidades: ['sede'],
        bullets: ['Estimulación musical temprana.', 'Para los más pequeños (0-3).', 'Juego, ritmo y vínculo.'] },
      { id: 'musica-ninos', area: 'Música', title: 'Música para niños 4-6', img: './assets/catalogo/musica-ninos.webp', modalidades: ['sede'],
        bullets: ['Primer acercamiento a la música.', 'Juego y exploración sonora.', 'Bases para seguir aprendiendo.'] },

      // ---- DANZA ----
      { id: 'ballet', area: 'Danza', title: 'Ballet', img: './assets/catalogo/ballet.webp', modalidades: ['sede'],
        bullets: ['Técnica, postura y elegancia.', 'Para niños, jóvenes y adultos.', 'Progreso por niveles.'] },
      { id: 'salsa', area: 'Danza', title: 'Salsa', img: './assets/catalogo/salsa.webp', modalidades: ['sede'],
        bullets: ['Aprende desde cero.', 'Conexión, ritmo y figuras.', 'Ambiente bacano y social.'] },
      { id: 'danza-urbana', area: 'Danza', title: 'Danza urbana', img: './assets/catalogo/danza-urbana.webp', modalidades: ['sede'],
        bullets: ['Estilos actuales y coreografías.', 'Energía y expresión.', 'Para jóvenes y adultos.'] },
      { id: 'ritmos-latinos', area: 'Danza', title: 'Ritmos latinos', img: './assets/catalogo/ritmos-latinos.webp', modalidades: ['sede'],
        bullets: ['Salsa, merengue y más.', 'Suelta el cuerpo y disfruta.', 'Ideal para empezar a bailar.'] },
      { id: 'danza-ninos', area: 'Danza', title: 'Danza para niños', img: './assets/catalogo/danza-ninos.webp', modalidades: ['sede'],
        bullets: ['Coordinación y ritmo jugando.', 'Confianza y expresión.', 'Pensada para los más pequeños.'] },
      { id: 'preu-danza', area: 'Danza', title: 'Preuniversitario danza', img: './assets/catalogo/preu-danza.webp', modalidades: ['sede'],
        bullets: ['Preparación para audiciones.', 'Técnica y repertorio.', 'Acompañamiento enfocado.'] },

      // ---- ARTES PLÁSTICAS ----
      { id: 'dibujo', area: 'Artes plásticas', title: 'Dibujo', img: './assets/catalogo/dibujo.webp', modalidades: ['sede', 'virtual'],
        bullets: ['Bases de forma, proporción, luz y color.', 'Proyectos guiados.', 'Para crear con más seguridad.'] },
      { id: 'pintura', area: 'Artes plásticas', title: 'Pintura', img: './assets/catalogo/pintura.webp', modalidades: ['sede', 'virtual'],
        bullets: ['Color, técnica y composición.', 'Proyectos personales.', 'Desde cero o avanzado.'] },
      { id: 'arte-infantil', area: 'Artes plásticas', title: 'Arte infantil', img: './assets/catalogo/arte-infantil.webp', modalidades: ['sede'],
        bullets: ['Creatividad y motricidad.', 'Exploración de materiales.', 'Diversión que enseña.'] },
      { id: 'preu-artes', area: 'Artes plásticas', title: 'Preuniversitario artes plásticas', img: './assets/catalogo/preu-artes.webp', modalidades: ['sede'],
        bullets: ['Portafolio para tu carrera.', 'Técnica y conceptos.', 'Preparación para admisión.'] },

      // ---- TEATRO ----
      { id: 'teatro-infantil', area: 'Teatro', title: 'Teatro infantil', img: './assets/catalogo/teatro-infantil.webp', modalidades: ['sede'],
        bullets: ['Expresión, confianza y creatividad.', 'Juegos escénicos.', 'Ideal para soltar la voz y el cuerpo.'] },
      { id: 'teatro-juvenil', area: 'Teatro', title: 'Teatro juvenil', img: './assets/catalogo/teatro-juvenil.webp', modalidades: ['sede'],
        bullets: ['Improvisación y montaje.', 'Trabajo en equipo.', 'Confianza para hablar en público.'] },
      { id: 'teatro-adultos', area: 'Teatro', title: 'Teatro para adultos', img: './assets/catalogo/teatro-adultos.webp', modalidades: ['sede'],
        bullets: ['Expresión y presencia escénica.', 'Suelta cuerpo y voz.', 'Un espacio para crear.'] },
      { id: 'expresion-escenica', area: 'Teatro', title: 'Expresión escénica', img: './assets/catalogo/expresion-escenica.webp', modalidades: ['sede', 'virtual'],
        bullets: ['Comunicación y oratoria.', 'Manejo del escenario.', 'Confianza frente al público.'] },

      // ---- OTROS SERVICIOS ----
      { id: 'vacacionales', area: 'Otros', title: 'Vacacionales artísticos', img: './assets/catalogo/vacacionales.webp', modalidades: ['sede'],
        bullets: ['Planes en temporada de vacaciones.', 'Varias artes en pocos días.', 'Diversión y aprendizaje.'] },
      { id: 'intensivos', area: 'Otros', title: 'Intensivos artísticos', img: './assets/catalogo/intensivos.webp', modalidades: ['sede'],
        bullets: ['Avanza mucho en poco tiempo.', 'Enfoque concentrado.', 'Ideal para metas puntuales.'] },
      { id: 'spaces', area: 'Otros', title: 'Musicala Spaces', img: './assets/catalogo/spaces.webp', modalidades: ['sede'],
        bullets: ['Espacios para crear y ensayar.', 'Ambiente artístico.', 'Pregunta por disponibilidad.'] },
      { id: 'tarjetas-regalo', area: 'Otros', title: 'Tarjetas regalo', img: './assets/catalogo/tarjetas-regalo.webp', modalidades: ['sede', 'virtual', 'online'],
        bullets: ['Regala arte a quien quieras.', 'Válida para varias áreas.', 'Un regalo que deja huella.'] },
      { id: 'musigym', area: 'Otros', title: 'MusiGym', img: './assets/catalogo/musigym.webp', modalidades: ['sede'],
        bullets: ['Entrenamiento artístico-corporal.', 'Energía y movimiento.', 'Pregúntanos cómo funciona.'] },
    ],

    /* ---------------------- VIDEOS POR ÁREA (sección destacada) ---------------------- */
    videos: [
      { area: 'Música', src: './assets/videos/musica-general.mp4', poster: './assets/posters/musica-general.webp', title: 'Música' },
      { area: 'Danza', src: './assets/videos/danza-general.mp4', poster: './assets/posters/danza-general.webp', title: 'Danza' },
      { area: 'Artes plásticas', src: './assets/videos/artes-plasticas.mp4', poster: './assets/posters/artes-plasticas.webp', title: 'Artes plásticas' },
      { area: 'Teatro', src: './assets/videos/teatro-general.mp4', poster: './assets/posters/teatro-general.webp', title: 'Teatro' },
    ],
